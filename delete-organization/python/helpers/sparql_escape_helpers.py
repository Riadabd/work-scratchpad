...
def sparql_escape_datetime(obj):
    ...
    if not isinstance(obj, datetime.datetime):
        ...
        obj = datetime.datetime.fromisoformat(
            str(obj)
        )  # only supports 3 or 6 digit microsecond notation (https://docs.python.org/3.7/library/datetime.html#datetime.datetime.fromisoformat)
...
def sparql_escape_time(obj):
    ...
    if not isinstance(obj, datetime.time):
        ...
        obj = datetime.time.fromisoformat(
            str(obj)
        )  # only supports 3 or 6 digit microsecond notation (https://docs.python.org/3.7/library/datetime.html#datetime.time.fromisoformat)
